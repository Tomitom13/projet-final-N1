...
document
  ...
  .addEventListener("click", miseAJourData, false);
document
  .querySelector("#updateData")
  .addEventListener("click", miseAJourDataLegend, false);
document
  .querySelector("#updateData")
  .addEventListener("click", miseAJourDataTeam, false);
