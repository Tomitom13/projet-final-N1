...
function login() {
    ...
    if (localStorage.getItem(username) === password) {
        ...
        document.querySelector("#errorLogin").innerHTML = "incorrect username or password !".bold();
...
function register() {
    ...
    if (localStorage.getItem(registerUserName.value) !== null) {
        ...
        document.querySelector("#errorNom").innerHTML = "That username is alreat in user, please choose another !".bold();
        ...
        document.querySelector("#errorNom").innerHTML = "Please enter a username !".bold();
        ...
        document.querySelector("#errorPassword").innerHTML = "That is to short, include 6 or more characters !".bold();
        ...
        alert("welcome " + registerUserName.value + " we direct you to the connection page !!");
