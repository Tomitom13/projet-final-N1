document
  ...
  .addEventListener("click", DataTitle, false);
document
  .querySelector("#updateData")
  .addEventListener("click", DataGround, false);
document
  .querySelector("#updateData")
  .addEventListener("click", DataSize, false);
document
  .querySelector("#updateData")
  .addEventListener("click", DataFurniture, false);
document.querySelector("#goBack").addEventListener("click", retourIndex, false);
document
  .querySelector("#removeData")
  .addEventListener("click", supprimerDataNews, false);
...
document.querySelector("#display").innerHTML = localStorage.getItem(
  "NamePerson"
);
