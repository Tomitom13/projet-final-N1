document.querySelector('#Nb_Color').addEventListener("change", displaycolor, false);
...
function displayMeuble() {
    ...
    if (document.getElementById("furniture").value == 'all') {
        ...
        tab = document.querySelectorAll("." + document.getElementById("furniture").value);
        for (var i = 0; i < tab.length; i++) {
            tab[i].style.display = 'inline-block';
        }
    }
...
function saveData() {
    ...
    localStorage.setItem("color1", document.querySelector('#color_choice_1').value);
    localStorage.setItem("color2", document.querySelector('#color_choice_2').value);
    localStorage.setItem("color3", document.querySelector('#color_choice_3').value);
    localStorage.setItem("color4", document.querySelector('#color_choice_4').value);
    localStorage.setItem("color4", document.querySelector('#color_choice_5').value);
